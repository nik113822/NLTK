...
Αν θέλετε να δείτε το μενού επιλογών του προγράμματος ανά πάσα στιγμή, πληκτρολογήστε:
python main.py -h
...
python mian.py ola ➜ Εκπαίδευση και των 3 αλγορίθμων

4)Εγκατάσταση Απαιτήσεων
Βεβαιωθείτε ότι έχετε εγκατεστημένη την Python. 
Στη συνέχεια, ανοίξτε το τερματικό σας και εγκαταστήστε τις απαιτούμενες βιβλιοθήκες:
```bash
